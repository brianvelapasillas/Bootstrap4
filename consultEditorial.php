...
<div class="container">
  ...
  <div class="card border-primary mb-2 " >
    <div class="card-header">
      <center> <h4>Consult Editorial</h4> </center>
    </div>
  </div>    
          ...
          <form action="listing.php" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  placeholder= "captura el nombre de la editorial" value="<?php echo $row['name_editorial']; ?>" readonly>
                </div>
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="city"
                     placeholder= "captura el nombre de la ciudad" value="<?php echo $row['city']; ?>" readonly>
                 </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="state"
                     placeholder= "Enter the 2 initials of your state" value="<?php echo $row['state']; ?>" readonly>
                  </div>
                </div>
              </div> <!--row-->
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                       ...
                       <button type="submit" name="accept" value="Accept" class="btn btn-primary">Return</button>
                    </div>
