...
<div class="container">
  ...
  <div class="card border-primary mb-2 " >
    <div class="card-header">
      <a href="addEditorial.php"class=" btn btn-outline-success">Add</a>
    </div>
  </div>    
      ...
      <tbody>
        ...
        <?php
          ...
          while($row = mysqli_fetch_array($result)){
            ...
            echo '<td>'.'<a href= "modifyEditorial.php?id_editorials='.$row['id_editorials'].'" class="btn btn-success">Modify</a>'.'</td>';
            echo '<td>'.'<a href= "eraseEditorial.php?id_editorials='.$row['id_editorials'].'" class="btn btn-danger">Delete</a>'.'</td>';
            echo '<td>'.'<a href= "consultEditorial.php?id_editorials='.$row['id_editorials'].'" class="btn btn-primary">Consult</a>'.'</td>';
            echo '</tr>';
