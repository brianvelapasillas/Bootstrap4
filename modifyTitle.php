...
<div class="container">
  ...
  <div class="card border-primary mb-2 " >
    <div class="card-header">
      <center> <h4>Modify Title</h4> </center>
    </div>
  </div>    
    ...
    <div class="card-body">
      ...
      <form action="updateTitle.php" method="POST">
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['title']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['type']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['price']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['down_payment']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['total_sales']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['publication_date']; ?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              placeholder= "captura el nombre de la editorial" value="<?php echo $row['note']; ?>" required>
            </div>
